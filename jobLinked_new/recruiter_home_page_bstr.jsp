...
<body>
					...
					<div class="col-md-6">
						<div class="form-block">
							<div class="text-center mb-5">
								<h3>
									Login to <strong>Recruiter Module</strong>
								</h3>
							</div>
							<html:form action="/recLoginPath">								
								...
								<div class="d-sm-flex mb-5">
									<span class="ml-auto"> 
									<a
										href="recForgetPassPath.do" class="forgot-pass"
	...
	<!--show error message-->
	<logic:notEmpty property="loginerror" name="RecFormBean">
		<script type="text/javascript">
			swal("Warning!", "${RecFormBean.loginerror}", "warning");
		</script>
	</logic:notEmpty>
