...
<body>
				...
				<div class="carousel-container">
					<div class="container">
						<h2 class="animate__animated animate__fadeInDown">
							Welcome to <span>Job Seeker Module</span>
						</h2>
						<p class="animate__animated animate__fadeInUp">
							Welcome to Our Job Linked Management system <br>Here You can
							manage Your Data<br> You can also easily apply to Job Posts.<br>Go
							on the above menu section links to perform your operations
						</p>
					</div>
				</div>
			</div>
	...
	<logic:notEmpty property="successMsg" name="EmpLoginFormBean">
		<script type="text/javascript">
			swal("Success!", "${EmpLoginFormBean.successMsg}", "success");
		</script>
	</logic:notEmpty>
