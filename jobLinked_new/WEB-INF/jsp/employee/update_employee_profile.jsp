...
<body>
	...
	<div class="container mt-5">
		<div class="main-body">
			<html:form action="/empUpdatePath" method="post"
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column align-items-center text-center">
									...
									<br>
									<html:file property="frmUploadImage"
										value="Choose Profile Photo" styleClass="form-control" />
									<div class="mt-3">
										<h4>${EmpViewProfileBean.frmEmployee.firstName}
											${EmpViewProfileBean.frmEmployee.lastName}</h4>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9 text-secondary">
										<html:text property="frmFatherName" styleClass="form-control"
											disabled="false"></html:text>
									</div>
								</div>
								<div class="row mb-3">
