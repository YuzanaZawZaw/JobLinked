...
<body>
		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-md-6">
						<h2>
							<font color="#836ea7">Recruiter Change Password</font>
						</h2>
					</div>
				</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column">
									<div class="mt-3">
										<html:form action="/recChangePasswordPath">						
	...
	<!-- show error message -->
	<c:if test="${RecFormBean.passwordError!=null}">
		<script type="text/javascript">
        swal("Warning!", "${RecFormBean.passwordError}", "warning");
      </script>
	</c:if>
