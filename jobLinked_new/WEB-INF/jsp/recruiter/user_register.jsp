...
<body>
	<!-- ======= Header ======= -->
	<jsp:include page="/WEB-INF//jsp/recruiter/recruiter_home_menu_bstr.jsp"></jsp:include>
	<!-- End Header -->
	<br>
	<br>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column">
									<div class="mt-3">
										<html:form action="/recRegisterPath">
											<logic:empty property="frmRegFormControl" name="RecFormBean">
												<div class="mt-3">
													<font color="red">
														<html:errors property="registError" /> 
														<html:errors
															property="frmFirstName" /> 
														<html:errors
															property="frmLastName" />														
														<html:errors
															property="frmEmail" /> 
														<html:errors
															property="frmPassword" /> 
														<html:errors
															property="frmPhone" />
														<html:errors
															property="frmBirthDate" />
														<html:errors
															property="frmNrc" />
														<html:errors
															property="frmGender" />	
											...
											<logic:notEmpty property="frmRegFormControl" name="RecFormBean">
												<div class="row mt-3">
													<div class="col-md-6">
														<html:text property="frmFirstName"
	...
	<!--show error message-->
	<c:if test="${RecFormBean.registError!=null}">
		<script type="text/javascript">
        swal("Warning!", "${RecFormBean.registError}", "warning");
      </script>
	</c:if>
